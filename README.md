...
> **[Visit My Portfolio](https://portfolio-one-ochre-53.vercel.app/)** *(My personal portfolio and project showcase)*
...
```text
🛠️  Currently Building  →  Flex Chat (E2EE Real-Time Messaging Platform)
🌱  Currently Learning  →  PostgreSQL · System Design · WebRTC
💼  Open To            →  Freelance Projects · Open Source Collabs
...
**Stack:** Next.js · Node.js · MongoDB · Redis · BullMQ · Docker · Nginx · Azure · Cloudflare · TypeScript

🔗 **[NPM Package](https://www.npmjs.com/package/ucoder-insight)** | 💻 **[GitHub Repository](https://github.com/soumydip/ucoder_insight_core)**
